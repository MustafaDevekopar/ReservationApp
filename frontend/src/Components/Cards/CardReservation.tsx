...
const CardReservation = (props: Props) => {
  return (
    ...
    <div className="flex rounded-3xl h-[120px] w-full overflow-hidden shadow-xl">
    {/* right   */}
   <div className="flex-[2] flex flex-col items-center justify-center bg-Darkgreen text-xs text-white">
    ...
    {/* left  */}
   <div className="flex-[3] flex flex-col text-xs p-2">
     <div className="flex-1">
       <div className="flex justify-between">
         <span className="py-2">ملعب سباعي الرمادي</span>
         <img className="w-6 h-6 rounded-full p-1 bg-white" src={xIcon} alt="" />
       </div>
       <div>
     ...
     <div className="flex-1 inline-flex  justify-between items-center">
       <img className="w-8 h-8 rounded-full p-1 bg-white" src={phoneBlackIcon} alt="" />
